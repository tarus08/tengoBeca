...
public class Llamada9_31 implements Serializable {
    ...
    static List<Llamada9_31> llamadaList = new ArrayList<Llamada9_31>();
    ...
    public void setPhoneNumClient(Integer phoneNumClient) {
        this.phoneNumClient = phoneNumClient;
    }
    ...
    public void setPhoneNumberWorker(Integer phoneNumberWorker) {
        this.phoneNumberWorker = phoneNumberWorker;
    }
